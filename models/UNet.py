...
class UNet(object):
    def __init__(self, img_shape, num_of_class, loaded_model = None, path = "saved_models/UNet_model", actf = 'relu',
    ...
    def enc_conv_block_4(self, inputs, feature_maps, filter_size = (3, 3),
        ...
        pool = MaxPooling2D(pooling_filter_size, strides = pooling_strides)(conv4)
    ...
    def build_model_VGG19(self):
        ...
        if self.model is None:
            ...
            # Expanding path
            dec_path = self.decoding_path_VGG19(mid_path4, concat1, concat2, concat3, concat4)
            segmented = Conv2D(self.num_of_class, (1,1), activation ='sigmoid', padding = 'same', kernel_initializer = 'glorot_normal')(dec_path)
